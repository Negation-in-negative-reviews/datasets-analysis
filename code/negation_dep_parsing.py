...
if __name__ == "__main__":
    ...
    #     "category", 
    #     os.path.join(saves_dir, "overall", overall_save_prefix+"_"+str(args.analysis_type)+"_non_amz"),
    #     ylim_top=ylim_top,
    #     y_axis_name="#occurences")
    ...
    #     "category", 
    #     os.path.join(saves_dir, "overall", overall_save_prefix+"_"+str(args.analysis_type)+"_amz"),
    #     ylim_top=ylim_top,
    #     y_axis_name="#occurences", amazon_data_flag=True)
